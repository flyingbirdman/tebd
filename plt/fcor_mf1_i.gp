...
if(!exist("outfile")) outfile=topdf.'corf_mf1_i.pdf'; else outfile=topdf.outfile.'corf_mf1_i.pdf'
if(!exist("yl")) yl=3.2
if(!exist("xl")) xl=6.4
...
set title '(a)'
set ylabel 'Im<D_{k,14}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=7
...
set title '(b)'
set ylabel 'Im<D_{k,41}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=8
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(c)'
set ylabel 'Im<D_{k,23}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=9
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(d)'
set ylabel 'Im<D_{k,32}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=10
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
