...
set label '{/Garamond-Premier-Pro-Italic=16 X_1}' at graph 0.55/len+dx, dy
set label '{/Garamond-Premier-Pro-Italic=16 X_2}' at graph 1.05/len+dx, dy
set label '{/Garamond-Premier-Pro-Italic=16 O}' at graph 1.7/len+dx, dy
set label '{/Garamond-Premier-Pro-Italic=16 Y_1}' at graph 2.2/len+dx, dy
set label '{/Garamond-Premier-Pro-Italic=16 O}' at graph 2.85/len+dx, dy
set label '{/Garamond-Premier-Pro-Italic=16 M_1}' at graph 3.4/len+dx,dy
set label '{/Garamond-Premier-Pro-Italic=16 M_2}' at graph 3.9/len+dx, dy
