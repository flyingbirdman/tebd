...
if(!exist("outfile")) outfile=topdf.'corf_mf.pdf'; else outfile=topdf.outfile.'corf_mf.pdf'
if(!exist("yl")) yl=3.2
if(!exist("xl")) xl=6.4
...
set title '(a)'
set ylabel 'Re<D_{k,11}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=15
...
set title '(b)'
set ylabel 'Re<D_{k,22}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=16
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(c)'
set ylabel 'Re<D_{k,33}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=17
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(d)'
set ylabel 'Re<D_{k,44}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=18
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
