...
if(!exist("outfile")) outfile=topdf.'ent.pdf'; else outfile=topdf.outfile.'ent.pdf'
if(!exist("yl")) yl=1.6
if(!exist("xl")) xl=2.1
...
set title '(a)'
set xlabel 'j'
set xrange [0.5:(25+0.5)]
set ylabel 'ent_vn' offset 0.5, 0.0
if(!exist("prefix")){
exit
}else{
	r=3
	plot for [i=1:numvar] prefix.word(var,i).postfix index r u ($0):1 w lp ls i t word(var,i)
}
