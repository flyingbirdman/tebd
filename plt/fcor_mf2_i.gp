...
if(!exist("outfile")) outfile=topdf.'corf_mf2_i.pdf'; else outfile=topdf.outfile.'corf_mf2_i.pdf'
if(!exist("yl")) yl=3.2
if(!exist("xl")) xl=6.4
...
set title '(a)'
set ylabel 'Im<D_{k,13}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=11
...
set title '(b)'
set ylabel 'Im<D_{k,31}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=12
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(c)'
set ylabel 'Im<D_{k,24}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=13
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
...
set title '(d)'
set ylabel 'Im<D_{k,42}>' offset 0.5, 0.0
if(!exist("prefix")){
	r=14
	plot locfile index r u 1:2 w lp ls 1, "" index r u 1:3 w lp ls 2
}else{
